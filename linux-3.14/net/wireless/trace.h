...
TRACE_EVENT(rdev_tdls_mgmt,
	...
	TP_ARGS(wiphy, netdev, peer, action_code, dialog_token, status_code, u32 peer_capability,
		buf, len),
	TP_STRUCT__entry(
		WIPHY_ENTRY
		NETDEV_ENTRY
	...
	TP_printk(WIPHY_PR_FMT ", " NETDEV_PR_FMT ", " MAC_PR_FMT ", action_code: %u, "
		  ...
		  __entry->status_code, __entry->peer_capability, ((u8 *)__get_dynamic_array(buf))[0])
);
