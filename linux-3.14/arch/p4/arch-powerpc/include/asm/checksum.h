/*
 * ported from include/asm-powerpc/checksum.h
 * 20061026, azu@sysgo.de
 */
#ifndef _P4_POWERPC_CHECKSUM_H
#define _P4_POWERPC_CHECKSUM_H
 ...
 */
extern __wsum csum_partial(const void *buff, int len,
				 __wsum sum);
