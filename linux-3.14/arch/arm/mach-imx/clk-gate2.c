...
static int stub_enable(struct clk_hw *hw)
{
...
static void stub_disable(struct clk_hw *hw)
{
	pr_debug("%s: Ignore clk_disable\n", __clk_get_name(hw->clk));
}

static const struct clk_ops stub_ops = {
	.enable = stub_enable,
...
#ifdef CONFIG_P4_BSP_ARCH_MXC
	if (strcmp(name, "enet") == 0 ||
	    strcmp(name, "uart_serial") == 0 ||
	    strcmp(name, "uart_ipg") == 0 ||
	    strcmp(name, "can1_ipg") == 0 ||
	    strcmp(name, "can1_serial") == 0 ||
	    strcmp(name, "can2_ipg") == 0 ||
	    strcmp(name, "can2_serial") == 0 ||
	    strcmp(name, "ecspi2") == 0 ||
	    strcmp(name, "i2c3") == 0)
		init.ops = &stub_ops;
#endif
