...
typedef enum icalvalue_kind {
   ICAL_ANY_VALUE=5000,
    ICAL_DATETIME_VALUE=5001,
    ICAL_CARLEVEL_VALUE=5002,
    ICAL_RECUR_VALUE=5003,
    ICAL_CALADDRESS_VALUE=5004,
    ICAL_PERIOD_VALUE=5005,
    ICAL_DATETIMEPERIOD_VALUE=5006,
    ICAL_QUERYLEVEL_VALUE=5007,
    ICAL_METHOD_VALUE=5008,
    ICAL_XLICCLASS_VALUE=5009,
    ICAL_DURATION_VALUE=5010,
    ICAL_TRANSP_VALUE=5011,
    ...
    ICAL_TRIGGER_VALUE=5023,
    ICAL_URI_VALUE=5024,
    ICAL_DATE_VALUE=5025,
    ICAL_ACTION_VALUE=5026,
    ICAL_TEXT_VALUE=5027,
    ICAL_FLOAT_VALUE=5028,
    ICAL_REQUESTSTATUS_VALUE=5029,
