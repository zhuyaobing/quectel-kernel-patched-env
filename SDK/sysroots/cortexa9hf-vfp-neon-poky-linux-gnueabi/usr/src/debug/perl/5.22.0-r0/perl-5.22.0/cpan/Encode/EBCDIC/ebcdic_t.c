/*
 ...
 /data/jenkins/workspace/alex-platform_CI_master/build/tmp/sysroots/x86_64-linux/usr/bin/perl-native/perl5.22.0.real ../bin/enc2xs -Q -O -o ebcdic_t.c -f ebcdic_t.fnm
 enc2xs VERSION 2.17
*/
#include "encode.h"
