...
set_target_properties(GTest::gtest PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "/usr/lib/libgtest.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS GTest::gtest )
list(APPEND _IMPORT_CHECK_FILES_FOR_GTest::gtest "/usr/lib/libgtest.a" )
...
set_target_properties(GTest::gtest_main PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "/usr/lib/libgtest_main.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS GTest::gtest_main )
list(APPEND _IMPORT_CHECK_FILES_FOR_GTest::gtest_main "/usr/lib/libgtest_main.a" )
...
set_target_properties(GTest::gmock PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_NOCONFIG "CXX"
  IMPORTED_LINK_INTERFACE_LIBRARIES_NOCONFIG "Threads::Threads;GTest::gtest"
  IMPORTED_LOCATION_NOCONFIG "/usr/lib/libgmock.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS GTest::gmock )
list(APPEND _IMPORT_CHECK_FILES_FOR_GTest::gmock "/usr/lib/libgmock.a" )
...
set_target_properties(GTest::gmock_main PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "/usr/lib/libgmock_main.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS GTest::gmock_main )
list(APPEND _IMPORT_CHECK_FILES_FOR_GTest::gmock_main "/usr/lib/libgmock_main.a" )
